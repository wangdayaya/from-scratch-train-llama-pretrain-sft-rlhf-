...
from model.llama_moe import LlamaForCausalLM, GenerateTextCallback
from model.llama_moe_config import LMConfig



def main():

    output_dir = "llama_moe_pretrain_hq_0409"
    # 加载配置
    print("加载 config")
    ...
    training_args = TrainingArguments(
        ...
        do_eval=True,
        seed=42,
        per_device_train_batch_size=160,  # 10
    ...
    swanlab_callback = SwanLabCallback(
        project="llama_moe_from_scratch_pretrain",
