...
if __name__ == '__main__':
    ...
    # 加载模型
    print("加载训练好的模型")
    model = torch.load(f"./out/sft_hq_0326.pth")
    ref_model = torch.load(f"./out/sft_hq_0326.pth").eval().to('cuda')
    ...
    trainer = DPOTrainer(
        ...
        callbacks=[
            swanlab_callback,
            ChatCallback(tokenizer, generate_every=10, max_length=1024)]
    )
