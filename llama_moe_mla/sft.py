...
from llama_moe_mla.model.llama_moe_mla import ChatCallback
...
def main():
    ...
    output_dir = "llama_moe_mla_sft_hq_0409"
    ...
    model.load_state_dict(torch.load('./final_model/llama_moe_mla_pretrain_hq_0330_state_dict.pth'))
    print(model)
    ...
    #     project="llama_moe_mla_from_scratch_sft",
